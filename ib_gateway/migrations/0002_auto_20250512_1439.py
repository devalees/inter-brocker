# Generated by Django 5.0.2 on 2025-05-12 14:39
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('broker', '0001_initial'),
        ('ib_gateway', '0001_initial'),
    ]

    operations = [
        # Drop the django_migrations record for the initial migration to force it to be reapplied
        migrations.RunSQL(
            "DELETE FROM django_migrations WHERE app='ib_gateway' AND name='0001_initial'",
